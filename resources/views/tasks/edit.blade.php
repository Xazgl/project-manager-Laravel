...
@section('content')
    ...
    <form method="post" action="{{ route('task.update',['id'=>$id,'task_id'=>$task_id]) }}"  enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="btn_two" style="margin-top: 30px">
        <a   href ="{{ route('tasks.show',['id'=>$id,'task_id'=>$task_id]) }}" class="btm_submit1" style="text-decoration: none">Назад</a>
